...
$.get({
  url: '/SIA/juridico/datos/Sessions',
  async: false,
...
if (nUsr != "" && nCampana != "") {
  ...
  $.ajax({
    type: 'GET',
    url: '/SIA/lstModulosByUsuarioCampana/' + nCampana,
    ...
    error: function error(xhr, textStatus, _error) {
      alert('ERROR: En function cargarMenu(nCampana)  ->  statusText: ' + xhr.statusText + ' TextStatus: ' + textStatus + ' Error:' + _error);
    }
  });
} else {
